...
template <>
const EVP_CIPHER* GetCipherForKeySize<SupportedCipherTypes::AES_GCM>(size_t cbKey)
{
...
template <>
const EVP_CIPHER* GetCipherForKeySize<SupportedCipherTypes::CHACHA20_POLY1305>(size_t cbKey)
{
